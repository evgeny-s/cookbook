...
export const config: Config = {
    dishes: [{
        ...
        ingredients: [
            ...
            {title: 'Лук', amount: 4, unit: 'шт'},
            {title: 'Картофель', amount: 1, unit: 'упак'},
            {title: 'Макароны (паутинка)', amount: 1, unit: 'упак'},
            {title: 'Зелень (укроп, лук, зелень)', amount: 1, unit: 'шт'},
            {title: 'Специи', amount: 1, unit: 'шт'},
        ]
    }, {
        ...
        ingredients: [
            ...
            {title: 'Лук', amount: 4, unit: 'шт'},
            {title: 'Картофель', amount: 1, unit: 'упак'},
            {title: 'Горох', amount: 1, unit: 'упак'},
            {title: 'Зелень (укроп, лук, зелень)', amount: 1, unit: 'шт'},
            {title: 'Специи', amount: 1, unit: 'шт'},
        ]
    }, {
        ...
        ingredients: [
            {title: 'Брокколи (мороженные)', amount: 1, unit: 'упак'},
            {title: 'Шампиньоны', amount: 300, unit: 'гр'},
            {title: 'Морковь', amount: 4, unit: 'шт'},
            {title: 'Лук', amount: 4, unit: 'шт'},
            {title: 'Картофель', amount: 1, unit: 'упак'},
            {title: 'Специи', amount: 1, unit: 'шт'},
            {title: 'Сливки', amount: 1, unit: 'упак'},
            {title: 'Плавленый сыр', amount: 1, unit: 'упак'},
        ]
    }, {
        id: uuid(),
        title: 'Окрошка',
        ...
        ingredients: [
            {title: 'Картофель', amount: 1, unit: 'упак'},
            {title: 'Яйца', amount: 1, unit: 'упак'},
            {title: 'Сметана', amount: 1, unit: 'упак'},
        ...
        ingredients: [
            {title: 'Картофель', amount: 1, unit: 'упак'},
            {title: 'Гречка', amount: 1, unit: 'упак'},
            {title: 'Морковь', amount: 4, unit: 'шт'},
            {title: 'Лук', amount: 4, unit: 'шт'},
            {title: 'Зелень (укроп, лук, зелень)', amount: 1, unit: 'шт'},
            {title: 'Специи', amount: 1, unit: 'шт'},
            {title: 'Кости на суп (свинина или индейка)', amount: 1, unit: 'упак'},
        ]
    }, {
        id: uuid(),
        title: 'Рисовый суп',
        ...
        ingredients: [
            ...
            {title: 'Зелень (укроп, лук, зелень)', amount: 1, unit: 'шт'},
            {title: 'Специи', amount: 1, unit: 'шт'},
            {title: 'Кости на суп (свинина или индейка или курица)', amount: 1, unit: 'упак'},
        ]
    }, {
        id: uuid(),
        title: 'Капустняк',
        ...
        ingredients: [
            ...
            {title: 'Зелень (укроп, лук, зелень)', amount: 1, unit: 'шт'},
            {title: 'Специи', amount: 1, unit: 'шт'},
            {title: 'Пшено', amount: 1, unit: 'упак'},
            {title: 'Томат (паста)', amount: 1, unit: 'банка'},
        ]
    }, {
        id: uuid(),
        ...
        ingredients: [
            ...
            {title: 'Зелень (укроп, лук, зелень)', amount: 1, unit: 'шт'},
            {title: 'Специи', amount: 1, unit: 'шт'},
            {title: 'Оливки', amount: 1, unit: 'упак'},
            {title: 'Сметана', amount: 1, unit: 'упак'},
            {title: 'Рис', amount: 1, unit: 'упак'},
        ...
        ingredients: [
            {title: 'Рыба', amount: 1, unit: 'упак'},
            {title: 'Овощи замороженные', amount: 1, unit: 'упак'},
            {title: 'Картофель', amount: 1, unit: 'упак'},
            {title: 'Морковь', amount: 4, unit: 'шт'},
            {title: 'Лук', amount: 4, unit: 'шт'},
            {title: 'Зелень (укроп, лук, зелень)', amount: 1, unit: 'шт'},
            {title: 'Специи', amount: 1, unit: 'шт'},
            {title: 'Пшеничная или ячневая крупа', amount: 1, unit: 'упак'},
        ]
    }, {
        id: uuid(),
        ...
        ingredients: [
            {title: 'Куриное филе', amount: 1, unit: 'упак'},
            {title: 'Лук', amount: 4, unit: 'шт'},
        ...
        ingredients: [
            ...
            {title: 'Специи', amount: 1, unit: 'упак'},
            {title: 'Зелень', amount: 1, unit: 'упак'},
        ...
        ingredients: [
            {title: 'Фарш свинной', amount: 1, unit: 'упак'},
            {title: 'Яйца', amount: 1, unit: 'упак'},
        ...
        ingredients: [
            {title: 'Фарш куриный', amount: 1, unit: 'упак'},
            {title: 'Яйца', amount: 1, unit: 'упак'},
            {title: 'Батон', amount: 1, unit: 'шт'},
            {title: 'Лук', amount: 3, unit: 'шт'},
            {title: 'Чеснок', amount: 1, unit: 'шт'},
            {title: 'Сухари панировочные', amount: 1, unit: 'упак'},
            {title: 'Молоко', amount: 1, unit: 'бутылка'},
        ]
    }, {
        id: uuid(),
        ...
        ingredients: [
            {title: 'Фарш (любой)', amount: 1, unit: 'упак'},
            {title: 'Яйца', amount: 1, unit: 'упак'},
            {title: 'Лук', amount: 3, unit: 'шт'},
            {title: 'Чеснок', amount: 1, unit: 'шт'},
            {title: 'Томатная паста', amount: 1, unit: 'банка'},
        ...
        ingredients: [
            {title: 'Филе куриное', amount: 1, unit: 'упак'},
            {title: 'Морковь', amount: 3, unit: 'шт'},
            {title: 'Лук', amount: 3, unit: 'шт'},
            {title: 'Рис', amount: 1, unit: 'упак'},
            {title: 'Чеснок', amount: 3, unit: 'шт'},
            {title: 'Специи для плова', amount: 1, unit: 'упак'},
        ]
    }, {
        id: uuid(),
        title: 'Плов с мясом',
        ...
        ingredients: [
            ...
            {title: 'Чеснок', amount: 3, unit: 'шт'},
            {title: 'Специи для плова', amount: 1, unit: 'упак'},
            {title: 'Чернослив/курага', amount: 1, unit: 'упак'},
        ]
    }, {
        id: uuid(),
        ...
        ingredients: [
            {title: 'Филе куриное', amount: 1, unit: 'упак'},
            {title: 'Помидоры черри', amount: 1, unit: 'упак'},
            {title: 'Моцарелла', amount: 1, unit: 'упак'},
            {title: 'Специи для курицы', amount: 1, unit: 'упак'},
        ]
    }, {
        id: uuid(),
        title: 'Печень',
        ...
        ingredients: [
            ...
            {title: 'Специи для рыбы', amount: 1, unit: 'упак'},
            {title: 'Сметана или майонез', amount: 1, unit: 'упак'},
            {title: 'Горчица', amount: 1, unit: 'упак'},
        ]
    }, {
        id: uuid(),
        ...
        ingredients: [
            ...
            {title: 'Зелень', amount: 1, unit: 'упак'},
            {title: 'Томатная паста', amount: 1, unit: 'банка'},
            {title: 'Сметана или сливки', amount: 1, unit: 'упак'},
        ]
    }, {
        id: uuid(),
        title: 'Пальчики',
        ...
        ingredients: [
            ...
            {title: 'Специи', amount: 1, unit: 'упак'},
            {title: 'Зубочистки (деревянные)', amount: 1, unit: 'упак'},
        ]
    }, {
        id: uuid(),
        ...
        ingredients: [
            ...
            {title: 'Укроп', amount: 1, unit: 'упак'},
            {title: 'Специи', amount: 1, unit: 'упак'},
        ]
    }, {
        id: uuid(),
        ...
        ingredients: [
            {title: 'Рис басмати', amount: 1, unit: 'упак'},
            {title: 'Смесь овощная замороженная', amount: 1, unit: 'упак'},
        ]
    }, {
        id: uuid(),
        title: 'Булгур',
        ...
        ingredients: [
            {title: 'Булгур', amount: 1, unit: 'упак'},
            {title: 'Морковь', amount: 3, unit: 'шт'},
            {title: 'Лук', amount: 3, unit: 'шт'},
        ]
    }, {
        ...
        ingredients: [
            {title: 'Макароны', amount: 1, unit: 'упак'},
            {title: 'Масло сливочное', amount: 100, unit: 'гр'},
        ]
    }, {
        id: uuid(),
        ...
        ingredients: [
            ...
            {title: 'Мука', amount: 1, unit: 'упак'},
            {title: 'Яйцо', amount: 3, unit: 'шт'},
            {title: 'Дрожжи сухие', amount: 1, unit: 'упак'},
            {title: 'Сода', amount: 1, unit: 'упак'},
        ...
        ingredients: [
            ...
            {title: 'Куриная грудка', amount: 1, unit: 'упак'},
            {title: 'Перец (сладкий)', amount: 3, unit: 'шт'},
            {title: 'Майонез', amount: 1, unit: 'банка'},
        ]
    }, {
        ...
        ingredients: [
            ...
            {title: 'Сыр (фета)', amount: 1, unit: 'упак'},
            {title: 'Маслины без косточек', amount: 1, unit: 'банка'},
            {title: 'Орегано (сушеное)', amount: 1, unit: 'упак'},
            {title: 'Лимон', amount: 1, unit: 'шт'},
        ...
        ingredients: [
            {title: 'Свекла', amount: 4, unit: 'шт'},
            {title: 'Майонез', amount: 1, unit: 'банка'},
            {title: 'Орехи грецкие', amount: 1, unit: 'упак'},
        ]
    }, {
        id: uuid(),
        ...
        ingredients: [
            ...
            {title: 'Мука', amount: 1, unit: 'упак'},
            {title: 'Яйцо', amount: 3, unit: 'шт'},
            {title: 'Ванилин', amount: 1, unit: 'упак'},
        ]
    }, {
        id: uuid(),
        ...
        ingredients: [
            {title: 'Творог', amount: 2, unit: 'упак'},
            {title: 'Яйцо', amount: 3, unit: 'шт'},
